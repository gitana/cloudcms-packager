...
var createPackager = function(basePath, workingFolder, outputPath, archiveGroup, archiveName, archiveVersion)
{
    ...
    r.addTaxonomyNode = function(json)
    {
        json._type = json._type || "n:taxonomy";
        json.title = json.title || "";
        json.description = json.description || "";
        json._existing = json._existing || {
            _existing: {
                _type: json._type,
                title: json.title
            }            
    ...
    r.addTaxonomyTermNode = function(parent, json, alternateId)
    {
        json._type = json._type || "n:taxonomy-term";
        json.title = json.title || "";
        json.description = json.description || "";
        ...
        json.key = json.key || "";
        json._existing = json._existing || {};
        json._existing._type = json._existing._type || json._type;
        json._existing.title = json._existing.title || json.title;

        var node = _addNode(json);
        _addAssociation(parent, node, {_type: "a:child"}, alternateId);
        return node;
    };

    r.classifyDocument = function(node, term, json, alternateId)
    {
        json._type = json._type || "n:taxonomy-term";
        json._existing = json._existing || {};
        json._existing._type = json._existing._type || json._type;
        ...
        _addAssociation(term, node, {_type: "a:has-taxonomy-term"}, alternateId);
        return node;
    };
